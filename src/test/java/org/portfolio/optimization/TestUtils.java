...
public class TestUtils {
    public static Instrument[] TEST_INSTRUMENTS = new Instrument[]{
        InstrumentUtil.mkInstrument(
            ...
            new double[] {0.79, 0.1, 0.06, 0.02, 0.009, 0.007, 0.006, 0.005, 0.0029, 0.0001}
            ),
        InstrumentUtil.mkInstrument(
            1,
            "Gazprom",
            ...
            new double[] {0.72, 0.13, 0.07, 0.04, 0.01, 0.009, 0.008, 0.007, 0.0055, 0.0005}
        ),
        InstrumentUtil.mkInstrument(
            1,
            "Rosneft",
            ...
            new double[] {0.8, 0.09, 0.06, 0.03, 0.008, 0.005, 0.004, 0.0024, 0.0005, 0.0001}
        ),
        InstrumentUtil.mkInstrument(
            1,
            "Bank Rossii",
            ...
            2030.0,
            new double[] {0.05, 0.008, 0.014, 0.015, 0.017, 0.020},
            new double[] {0.998, 0.001, 0.0005, 0.0003, 0.0001, 0.0001, 0.0, 0.0, 0.0, 0.0}
        )
    };
